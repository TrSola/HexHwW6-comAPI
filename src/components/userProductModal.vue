...
const emit = defineEmits(['emitModalInModalComponent', 'add-to-cart'])
const modalInModalComponent = ref(null)
const productModalRef = ref(null)
const qty = ref(1)

onMounted(() => {
  modalInModalComponent.value = new Modal(
    productModalRef.value,
    {
      backdrop: 'static'
    }
  )
  emit('emitModalInModalComponent', modalInModalComponent)
})
</script>
