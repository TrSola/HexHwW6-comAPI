  ...
  <div class='container'>
       <div class='mt-4'>
         ...
         <user-product-modal
           ...
           @emit-modal-in-modal-component="emitModalfromUserModal"
         ></user-product-modal>
...
const getProduct = (id) => {
  ...
  console.log(userProductModalRef.value.qty)
  axios
    .get(url)
    .then((response) => {
      loadingStatus.value.loadingItem = ''
      product.value = response.data.product
      emitModal.value.show()
    })
    .catch((err) => {
      alert(err.response.data.message)
    })
...
const emitModalfromUserModal = (modalInModalComponent, qty) => {
  emitModal.value = modalInModalComponent.value
}
